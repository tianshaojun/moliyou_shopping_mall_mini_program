var t = getApp(),
  e = t.requirejs("core"),
  s = (t.requirejs("icons"), t.requirejs("foxui"));
...
Page({
  ...
  onShow: function() {
    var e = this,
      s = t.getCache("isIpx"),
      a = t.getCache("orderAddress"),
      o = t.getCache("orderShop");
    o && e.setData({
      carrierInfo: o
  ...
  dispatch: function() {
    ...
    e.get("creditshop/create/dispatch", {
      ...
      optionid: that.options.id
    }, function(t) {
      var allprice = parseFloat(that.data.allprice) + parseFloat(that.data.goods.money)
      that.setData({
