...
Page((e = {
    ...
    getShop: function() {
        if (app.globalData.appid == '' || app.globalData.api == '') {
          let extConfig = wx.getExtConfigSync ? wx.getExtConfigSync() : {}
          if (extConfig) {
            app.globalData.appid = extConfig.appid;
            app.globalData.api = extConfig.api;
            app.globalData.approot = extConfig.approot;
        }
        wx.switchTab({
            url: '../index/index',
        })
    ...
    get_cpinfos: function() {
        ...
        s.get("shop/get_cpinfos", {}, function(a) {
          if (!!a && !!a.sysset){
            t.setData({
              sound: !a.sysset.is_silent_mode,
              soundpic: !!a.sysset.is_silent_mode
            })
          }
